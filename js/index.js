...
var dropdown_toggle = '<a class="dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">'
...
window.onload = function(){
    ...
    for(var i = 0; i < menulist.length; i++) {
        ...
        if(rlength == 1) {
            text = text + presentation_normal + '<a href="#">' + menulist[i][0] + '</a></li>'
        }
        else {
            text = text + presentation_dropdown + dropdown_toggle + menulist[i][0] + caret + '</a>' + dropdown_menu
